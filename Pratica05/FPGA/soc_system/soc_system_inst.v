	soc_system u0 (
		...
		.dualport_ram_clk2_clk                                (<connected-to-dualport_ram_clk2_clk>),                                //                       dualport_ram_clk2.clk
		.dualport_ram_reset2_reset                            (<connected-to-dualport_ram_reset2_reset>),                            //                     dualport_ram_reset2.reset
		.dualport_ram_reset2_reset_req                        (<connected-to-dualport_ram_reset2_reset_req>),                        //                                        .reset_req
		.dualport_ram_s2_address                              (<connected-to-dualport_ram_s2_address>),                              //                         dualport_ram_s2.address
		.dualport_ram_s2_chipselect                           (<connected-to-dualport_ram_s2_chipselect>),                           //                                        .chipselect
		.dualport_ram_s2_clken                                (<connected-to-dualport_ram_s2_clken>),                                //                                        .clken
		.dualport_ram_s2_write                                (<connected-to-dualport_ram_s2_write>),                                //                                        .write
		.dualport_ram_s2_readdata                             (<connected-to-dualport_ram_s2_readdata>),                             //                                        .readdata
		.dualport_ram_s2_writedata                            (<connected-to-dualport_ram_s2_writedata>),                            //                                        .writedata
		.dualport_ram_s2_byteenable                           (<connected-to-dualport_ram_s2_byteenable>),                           //                                        .byteenable
		...
		.avalon_mm_to_wishbone_bridge_0_wishbone_address      (<connected-to-avalon_mm_to_wishbone_bridge_0_wishbone_address>),      // avalon_mm_to_wishbone_bridge_0_wishbone.address
		.avalon_mm_to_wishbone_bridge_0_wishbone_datain       (<connected-to-avalon_mm_to_wishbone_bridge_0_wishbone_datain>),       //                                        .datain
		.avalon_mm_to_wishbone_bridge_0_wishbone_dataout      (<connected-to-avalon_mm_to_wishbone_bridge_0_wishbone_dataout>),      //                                        .dataout
		.avalon_mm_to_wishbone_bridge_0_wishbone_writeenable  (<connected-to-avalon_mm_to_wishbone_bridge_0_wishbone_writeenable>),  //                                        .writeenable
		.avalon_mm_to_wishbone_bridge_0_wishbone_selectarray  (<connected-to-avalon_mm_to_wishbone_bridge_0_wishbone_selectarray>),  //                                        .selectarray
		.avalon_mm_to_wishbone_bridge_0_wishbone_strobeout    (<connected-to-avalon_mm_to_wishbone_bridge_0_wishbone_strobeout>),    //                                        .strobeout
		.avalon_mm_to_wishbone_bridge_0_wishbone_acknowledged (<connected-to-avalon_mm_to_wishbone_bridge_0_wishbone_acknowledged>)  //                                        .acknowledged
	);
