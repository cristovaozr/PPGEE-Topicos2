	soc_system u0 (
		.avmm_to_wishbone_bridge_0_wishbone_address      (<connected-to-avmm_to_wishbone_bridge_0_wishbone_address>),      // avmm_to_wishbone_bridge_0_wishbone.address
		.avmm_to_wishbone_bridge_0_wishbone_datain       (<connected-to-avmm_to_wishbone_bridge_0_wishbone_datain>),       //                                   .datain
		.avmm_to_wishbone_bridge_0_wishbone_dataout      (<connected-to-avmm_to_wishbone_bridge_0_wishbone_dataout>),      //                                   .dataout
		.avmm_to_wishbone_bridge_0_wishbone_writeenable  (<connected-to-avmm_to_wishbone_bridge_0_wishbone_writeenable>),  //                                   .writeenable
		.avmm_to_wishbone_bridge_0_wishbone_selectarray  (<connected-to-avmm_to_wishbone_bridge_0_wishbone_selectarray>),  //                                   .selectarray
		.avmm_to_wishbone_bridge_0_wishbone_strobeout    (<connected-to-avmm_to_wishbone_bridge_0_wishbone_strobeout>),    //                                   .strobeout
		.avmm_to_wishbone_bridge_0_wishbone_acknowledged (<connected-to-avmm_to_wishbone_bridge_0_wishbone_acknowledged>), //                                   .acknowledged
